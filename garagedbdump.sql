...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `car_BEFORE_INSERT` BEFORE INSERT ON `car` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `car_BEFORE_UPDATE` BEFORE UPDATE ON `car` FOR EACH ROW BEGIN
	IF (NEW.yearReleased < 1950) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `customer_BEFORE_INSERT` BEFORE INSERT ON `customer` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `customer_BEFORE_UPDATE` BEFORE UPDATE ON `customer` FOR EACH ROW BEGIN
	IF (NEW.accCreationDate < '2021-01-01') THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `customer_rates_branch_BEFORE_INSERT` BEFORE INSERT ON `customer_rates_branch` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `customer_rates_branch_BEFORE_UPDATE` BEFORE UPDATE ON `customer_rates_branch` FOR EACH ROW BEGIN
	IF ((NEW.rating < 1) OR (NEW.rating > 10)) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `employee_BEFORE_INSERT` BEFORE INSERT ON `employee` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `employee_BEFORE_UPDATE` BEFORE UPDATE ON `employee` FOR EACH ROW BEGIN
	IF ((NEW.conStartDate < '2021-01-01') OR (NEW.conEndDate <= NEW.conStartDate)) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `monthly_branch_expenses_BEFORE_INSERT` BEFORE INSERT ON `monthly_branch_expenses` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `monthly_branch_expenses_BEFORE_UPDATE` BEFORE UPDATE ON `monthly_branch_expenses` FOR EACH ROW BEGIN
	IF (NEW.year < 2021) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `order_includes_part_BEFORE_INSERT` BEFORE INSERT ON `order_includes_part` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `order_includes_part_BEFORE_UPDATE` BEFORE UPDATE ON `order_includes_part` FOR EACH ROW BEGIN
	IF (NEW.quantity <= 0) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `repair_BEFORE_INSERT` BEFORE INSERT ON `repair` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `repair_BEFORE_UPDATE` BEFORE UPDATE ON `repair` FOR EACH ROW BEGIN
	IF ((NEW.estDuration <= 0) OR (NEW.date < '2021-01-01')) THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `spare_parts_order_BEFORE_INSERT` BEFORE INSERT ON `spare_parts_order` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`group38`@`localhost`*/ /*!50003 TRIGGER `spare_parts_order_BEFORE_UPDATE` BEFORE UPDATE ON `spare_parts_order` FOR EACH ROW BEGIN
	IF (NEW.date < '2021-01-01') THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Invalid data';
    END IF;
END */;;
...
/*!50013 DEFINER=`group38`@`localhost` SQL SECURITY DEFINER */
